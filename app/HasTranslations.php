...
trait HasTranslations
{
  ...
  {
    if (! ($this->isTranslatableAttribute($key) || $this->hasNestedTranslatable($key))) {
  ...
  public function hasNestedTranslatable(string $key): bool
  {
    return collect($this->getTranslatableAttributes())->contains(function ($_, $value) use ($key) {
      return Str::startsWith($value, $key . '.') || Str::startsWIth($value, $key . '*');
    });
  }
